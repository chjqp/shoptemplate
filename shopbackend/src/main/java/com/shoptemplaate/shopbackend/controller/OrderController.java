...
import com.shoptemplaate.shopbackend.properties.WeixinpayProperties;
import com.shoptemplaate.shopbackend.service.IOrderDetailService;
import com.shoptemplaate.shopbackend.service.IOrderService;
import com.shoptemplaate.shopbackend.util.*;
...
public class OrderController {
    ...
    public R create(@RequestBody Order order, @RequestHeader(value = "token") String token) {
        ...
        order.setOrderNo("Within Reach" + DateUtil.getCurrentDateStr());
    ...
    */
    ...
    public R preparePay(@RequestBody String orderNo,
    ...
    Order order = orderService.getOne(new QueryWrapper<Order>().eq("orderNo",
    orderNo));
    ...
    HttpClientUtil.sendXMLDataByPost(weixinpayProperties.getUrl().toString(),
    xml);
    ...
    */
    @RequestMapping("/list")
    public R list(Integer type,Integer page,Integer
    pageSize,@RequestHeader(value="token") String token){
    ...
    Page<Order> orderReslut =orderService.page(pageOrder,new
    QueryWrapper<Order>().eq("status",type));
    System.out.println("总记录："+orderReslut.getTotal());
    System.out.println("总页数："+orderReslut.getPages());
    System.out.println("当前页数据："+orderReslut.getRecords());
    orderList=orderReslut.getRecords();
